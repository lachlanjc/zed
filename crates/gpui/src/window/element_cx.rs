...
pub(crate) struct DeferredDraw {
    ...
    layout_range: Range<BeforePaintIndex>,
...
impl<'a> ElementContext<'a> {
    ...
    fn layout_deferred_draws(&mut self, deferred_draw_indices: &[usize]) {
        ...
        for deferred_draw_ix in deferred_draw_indices {
            ...
            if let Some(element) = deferred_draw.element.as_mut() {
                ...
                self.reuse_before_paint(deferred_draw.layout_range.clone());
            }
    ...
    pub fn defer_draw(
        ...
        window.next_frame.deferred_draws.push(DeferredDraw {
            ...
            absolute_offset,
            layout_range: BeforePaintIndex::default()..BeforePaintIndex::default(),
